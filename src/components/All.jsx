...
const All = () => {
    ...
    return (
        <div className='max-w-[361px] bg-[#DCFCE7] mx-auto pt-[22px]'>
            <div className='flex items-center justify-center py-1 gap-1 px-4 bg-[#F0FDF4] rounded max-w-[183px] mx-auto mb-[22px] data'>
                <img src={dataIcon} alt="timeIcon" />
                <p className='block text-xs font-bold leading-[14px]'>
