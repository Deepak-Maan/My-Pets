        ...
        <div className='max-w-[361px] bg-[#DCFCE7] mx-auto pt-[22px]'>
            <div className='flex items-center gap-2 justify-center'>
                <button
                    ...
                    className={`max-w-[98px] w-full rounded-[4px] py-2 flex justify-center font-normal text-base leading-4 border-[1px] border-solid border-[#052E1633] ${activeTab === 'all' ? 'bg-[#DCFCE7] text-[#052E16] border-[#052E1633] shadow-[2px_2px_0px_0px_#0C0A0980_inset]' : 'bg-[#F0FDF4] text-[#052E16] border-[#052E1633] shadow-[1px_1px_0px_0px_#052E1633]'
                        }`}
                >
                    All
                </button>
                <button
                    ...
                    className={`w-full rounded-[4px] py-2 flex justify-center font-normal text-base leading-4 border-[1px] border-solid border-[#052E1633]  max-w-[109px] ${activeTab === 'leaderboard' ? "" : '  bg-[#F0FDF4] text-[#052E16] border-[#166534] shadow-[1px_1px_0px_0px_#052E1633]'
                        }`}
                >
                    Leaderboard
                </button>
